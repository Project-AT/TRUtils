...
public class BlockOutlineRender {
    ...
    private final WeakHashMap<Object, BlockPos> positionProviders = new WeakHashMap<>();
    ...
    public void init() {
        ...
        ResourceLocation resourcelocation = new ResourceLocation(Main.MODID, "shaders/post/block_outline.json");
        ...
        try {
            ...
            this.outlineBuffer = this.shader.getFramebufferRaw("trutils:final");
